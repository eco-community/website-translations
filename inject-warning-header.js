...
let jaText = `
<p>これは非公式なものであり、コミュニティ主導の翻訳であるため、誤解を招いたり、不正確であったりする可能性があります。英語の公式コンテンツについては <a href="https://eco.com">Eco.com</a> をご覧ください。誤解を招くような内容、間違った内容、不足している内容を見つけ、貢献したいと思われる方は
